...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Testimonial - Add New</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                New Testimonial Details
                <div class="col-md-2 pull-right text-right"><a href="{{ url('/admin/testimonials') }}"><i class="fa fa-list fw"></i> Back To List</a></div>
            </div>

            <div class="panel-body">
                <div class="row">
                        <form name="frm_testimonial_new" id="frm_testimonial_new" class="form-horizontal" role="form" 
                              method="POST" action="{{ url('/admin/testimonials/') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
