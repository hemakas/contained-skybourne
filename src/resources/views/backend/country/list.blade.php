                    ...
                    <tbody>
                                ...
                                <tr class="odd {{$cls}}">
                                    ...
                                    <td class="center">
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" class="btnactivate" data-id="{{ $country->id }}" data-active="{{ $country->active }}" value="{{$country->active}}" @if($country->active == 1) checked="checked" @endif>
                                                           <span id="chk{{ $country->active }}"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </td>
                        ...
                        @else
                            <tr class="even gradeC">
                                <td colspan="9">Countries not found.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
