...
<div class="row">
    <div class="col-lg-12">
        <h1 class="menu-header">Menu - Add New</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
            ...
            <div class="panel-body">
                    ...
                    <div class="col-lg-12">
                        <form name="frm_menu_new" id="frm_menu_new" class="form-horizontal" role="form" 
                              method="POST" action="{{ url('/admin/menus/') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="form-group pull-left col-lg-12 {{ $errors->has('menustring') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-10">
                                    <input id="menustring" type="text" class="form-control" name="menustring" value="{{ old('menustring') }}">
                            ...
                            <div class="form-group pull-left col-lg-12 {{ $errors->has('menuurl') ? ' has-error' : '' }}">
                                <label for="menuurl" class="col-md-2 control-label">Menu Link</label>
                                <div class="col-md-10">
                                    <input id="menuurl" type="text" class="form-control" name="menuurl" value="{{ old('menuurl') }}">
                            ...
                            <div class="form-group pull-left col-lg-12 {{ $errors->has('submenuof') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="submenuof" id="submenuof">
                                        <option value="0" @if(old('submenuof') == 0) selected="selected" @endif >Select Main menu</option>
                                        @foreach($mainmenus as $mm)
                                        <option @if(old('submenuof') == $mm->id) selected="selected" @endif id="{{ $mm->id }}" value="{{ $mm->id }}" >{{ $mm->menustring }}</option>
                                        @endforeach
                                    </select>
