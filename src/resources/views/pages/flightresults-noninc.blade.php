...
<table class="table mobileonly" style="margin-top:10px;padding:5px;">
<tbody>
  <?php
...
<tr class="flightitineraries
<?php echo ($iti['pricing']['directFlights'] == true?" directflights":" nondirectflights");
echo ($iti['pricing']['ticketAirlineCode'] == true?" flightcode".$iti['pricing']['ticketAirlineCode']:""); ?> mobileonly" >
<td>

<?php if($iti['pricing']['ticketAirlineCode'] != ""){ ?>
      <img src="{{URL::asset('assets/img/airlines/'.$iti['pricing']['ticketAirlineCode'].'.jpg')}}" alt="{{$iti['pricing']['ticketAirlineName']}}" title="{{$iti['pricing']['ticketAirlineName']}}" class="img-responsive" style="max-width:72px;">
...
<p class="list_uppercase cityname font-twelve">
  ...
  <br>
  <span class="datetime" style="position:relative;width:75px;">{{\Carbon\Carbon::parse($journey['departureTime'])->format('D, d M \'y, H:i')}}</span>
</p>
...
<!-- end mobile-->
          <div class="row headingline mobilenone">
            ...
            <li class="flightitineraries
                <?php echo ($iti['pricing']['directFlights'] == true?" directflights":" nondirectflights");
                echo ($iti['pricing']['ticketAirlineCode'] == true?" flightcode".$iti['pricing']['ticketAirlineCode']:""); ?>  mobilenone" >
