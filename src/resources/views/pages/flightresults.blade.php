    ...
    <div class="col-sm-12">
                        ...
                        <ul>
                            ...
                            <li><a class="head">Flights</a>
                                <?php if (isset($summary["directMinPrice"]["amount"]) && isset($summary["nondirectMinPrice"]["amount"])) { ?>
                                    <div class="content">
                                        <div class="checkbox">
                                            <label><input type="checkbox" id="ckDirect" value="Direct" checked="checked"/>Direct<span class="pull-right"><?php echo $currencySymbol . round($summary["directMinPrice"]["amount"]); ?></span></label>
                                            <label><input type="checkbox" id="ckNonDirect" value="Non Direct" checked="checked"/>Non Direct<span class="pull-right"><?php echo $currencySymbol . round($summary["nondirectMinPrice"]["amount"]); ?></span></label>
                                        </div>
                                    </div>
                                <?php } ?>
                            </li>
                                ...
                                <li><a class="head">Airlines</a>
                                    <div class="content">
                                        ...
                                        <div class="checkbox" id="dvFilterAirline">
                                            <?php if (is_array($summary["availableFlights"])) {
                                                foreach ($summary["availableFlights"] as $sumfcode => $sumflight) { ?>
                                                    <label title="{{$sumflight['airlineName']}}">
                                                        <input checked="checked" class="comp filterfcode" data-mini="true" data-id="<?php echo $sumfcode; ?>" id="<?php echo $sumfcode; ?>" type="checkbox" value="">
                                                        <input name="Jet Airways" type="hidden" value="false">
        ...
        <div class="col-md-9">
            ...
            <div class="table-responsive mobileonly">
                @include('includes.incflightresultmobile')
            </div>
                ...
                @if(count($results) > 0)
                    @foreach($results as $iti)
                        <li class="flightitineraries
                            <?php
                                echo $iti["pricing"]["directFlights"] == true ? " directflights" : " nondirectflights";
                            ...
                            <div class="booking-item mobilenone">
                                <div class="row">
                                    <div class="col-sm-10">
                                        <div class="row set1">
                                            <?php if (is_array($iti["flightJournies"]) && !empty($iti["flightJournies"])) {
                                                $i = 0;
                                                foreach ($iti["flightJournies"] as $journey) { ?>
                                                    <div class="col-sm-1 iconplane <?php if (count($journey["flights"]) > 1) { echo "showFlightsDetails"; } ?>">
                                        ...
                                        <div class="col-sm-2 text-center pull-left clear">
                                            <div id="pricetag_results" class="grad_blue">
