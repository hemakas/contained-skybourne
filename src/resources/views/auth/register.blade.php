                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('adrsline1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="adrsline1" type="text" class="form-control" name="adrsline1" value="{{ old('adrsline1') }}">
                        ...
                        <div class="form-group{{ $errors->has('adrsline2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="adrsline2" type="text" class="form-control" name="adrsline2" value="{{ old('adrsline2') }}">
